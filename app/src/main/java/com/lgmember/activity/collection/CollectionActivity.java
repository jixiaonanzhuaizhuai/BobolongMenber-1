...
import com.lgmember.activity.score.HistoryScoresActivity;
import com.lgmember.activity.score.ScoresRuleActicity;
...
public class CollectionActivity extends FragmentActivity {
	...
	private Class fragmentArray[] = {
			ActivityCollection.class, ClubActicityCollection.class};
	...
	// Tab选项卡的文字
	private String mTextviewArray[] = { "活动收藏", "俱乐部活动收藏"};
	...
	private void initView() {
		...
		mTabHost.setup(CollectionActivity.this, getSupportFragmentManager(),
				R.id.realtabcontent);
