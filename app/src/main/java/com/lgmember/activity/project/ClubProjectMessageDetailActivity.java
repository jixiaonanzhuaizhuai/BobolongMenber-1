...
public class ClubProjectMessageDetailActivity extends BaseActivity implements View.OnClickListener, JoinActivityBusiness.JoinActivityResulHandler,CollectionAddBusiness.CollectionResulHandler,TopBarView.onTitleBarClickListener {
	...
	private void init(){
		...
		Glide.with(ClubProjectMessageDetailActivity.this).load(pictureUrl).placeholder(R.mipmap.defaul_background_img).into(imageView);
	...
	public void joinActivity(){
		...
		joinActivityBusiness.clubActivityJoin();
	}
